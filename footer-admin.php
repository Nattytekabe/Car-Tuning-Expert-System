...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>HillTown Garage</h4>
                    <p>Hotel Garage is the best garage you'll find in whole Ethiopia. We not only care about our present customers, but also we care about our past customers, focus on our future customer &amp; of course our big focus always lies on the comfort of our customers. In our website you can quickly customize  your car. You can go through all our spare parts, prices &amp; models, of course with images. We provide the pictures of cars. and garages to visit in Addis Abeba,Ethiopia. </p>
                </div>              
                 
                 <div class="col-sm-3">
                    <h4>Quick Links</h4>
                    <ul class="list-unstyled">
                        <li><a href="rooms-tariff.php">Cars</a></li>        
...
<div class="text-center copyright">Website by <a type="tab"  href="http://nattytekabe.webflow.com">Nathnael Kassa| Nebil Nejmudin | Mathias Mekuriaw | Thomas Addis </a> </div>
